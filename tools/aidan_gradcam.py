...
# Run this file:
# python tools/aidan_gradcam.py i3d_gaussian/i3d_config_00582992.py  checkpoints/train_all/00582992/best_top1_acc_epoch_1.pth videos/7942GT00.mp4 --target-layer-name backbone/layer4/1/relu --out-filename Video_GradCam/7942GT00_GradCam.mp4 --fps 10
# python tools/aidan_gradcam.py ${CONFIG_FILE}  ${CHECKPOINT_FILE} ${VIDEO_FILE} --target-layer-name backbone/layer4/1/relu --out-filename ${OUT_PATH} --fps 5
...
def main():
    ...
    if args.out_filename is not None:
        ...
        video_clips = ImageSequenceClip(frame_list, fps=5) #args.fps
