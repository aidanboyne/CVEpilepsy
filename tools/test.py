...
def parse_args():
    ...
    parser.add_argument(
        '--eval-save-dir',
        default=os.path.join(os.getcwd(),"test_results"),
...
def main():
    ...
    dataloader_setting = dict(
        videos_per_gpu=cfg.data.get('videos_per_gpu', 16),
    ...
    if rank == 0:
        ...
        if eval_config:
            ...
            with open(os.path.join(args.eval_save_dir,f'test_{current_time}.txt'), 'a') as file:
                file.write(f'\n\n{args.config}')
